...
import rightImage from '../images/mcstyle/right.png';
import leftImage from '../images/mcstyle/left.png';
import topImage from '../images/mcstyle/top.png';
import bottomImage from '../images/mcstyle/bottom.png';
import frontImage from '../images/mcstyle/front.png';
import backImage from '../images/mcstyle/back.png';
...
export default function example() {
  ...
  const topTexture = textureLoader.load(topImage);
  const bottomTexture = textureLoader.load(bottomImage);
